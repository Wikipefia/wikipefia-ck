...
export const metadata: Metadata = {
  title: "Wikipefia Admin",
  description: "Management console for Wikipefia projects, repos, and services",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        {/* biome-ignore lint/security/noDangerouslySetInnerHtml: themeScript is a hardcoded constant (no user input) — the standard no-flash theme bootstrap, same as apps/studio. */}
